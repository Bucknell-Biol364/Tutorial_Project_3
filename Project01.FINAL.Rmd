...
Covid_19 %>% #Calls the Covid_19 dataset to be acted on by the following functions
  ...
  summarise(State, Sex, Age.Group, COVID.19.Deaths) -> Covid_19.Deaths.by.Age #Selects only the relavent columns to our analysis and saves them to a new dataset titled "Covid_19.Deaths.by.Age"
