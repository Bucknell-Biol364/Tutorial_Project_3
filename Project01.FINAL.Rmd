...
The first line we are specifying which column of the data set we would like to look at and altering the data to ensure the variables are handled properly. 
When you look at the structure of the data set you can see that Year is listed as numerical but we would like it to be handled as a factor instead. 
...
* ggplot creates a quardinate system that you can add layers to. The first argument is where you input the dataset   to use in the graph
