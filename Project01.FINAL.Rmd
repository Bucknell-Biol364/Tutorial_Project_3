...
Notice that the product of this function is assigned the identity "lmEvsW" for East vs. West Coast. This analysis is performed using the CovidDataCoasts dataset, with both male and female sexes, by total, All Ages, excluding "United States", "New York City", and "Peurto Rico". Only 102 observations are present within the data frame
...
random distribution of variance
residuals are normally distributed
is line through all of those points straight\
